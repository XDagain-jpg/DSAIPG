...
public class PriorityQueueTest_4ary {
    ...
    public void testInverted1a() {
        ...
        binHeap[2] = "B";
        boolean max = false;
        Iterable<String> pq = new PriorityQueue_4ary<>(max, binHeap, 1, 2, Comparator.comparing(String::toString), false);
    ...
    public void testInverted1b() {
        ...
        binHeap[1] = "B";
        boolean max = false;
        Iterable<String> pq = new PriorityQueue_4ary<>(max, binHeap, 0, 2, Comparator.comparing(String::toString), false);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
    ...
    public void testSwimUp0() {
        ...
        Iterable<String> pq = new PriorityQueue_4ary<>(true, binHeap, 0, 2, Comparator.comparing(String::toString), true);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
    ...
    public void testSwimUp1() {
        ...
        Iterable<String> pq = new PriorityQueue_4ary<>(true, binHeap, 1, 2, Comparator.comparing(String::toString), false);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
    ...
    public void testSwimUp2() {
        ...
        Iterable<String> pq = new PriorityQueue_4ary<>(true, binHeap, 1, 4, Comparator.comparing(String::toString), false);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
        tester.invokePrivate("swimUp", 4); // Swim "C" upward.
        //original: assertEquals("C", tester.invokePrivate("peek", 2)); 
        //changed for 4-ary structure
        assertEquals("C", tester.invokePrivate("peek", 4)); // Peek at root.
    }
    ...
    public void testSwimUp3() {
        ...
        Iterable<String> pq = new PriorityQueue_4ary<>(false, binHeap, 1, 4, Comparator.comparing(String::toString), false);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
    ...
    public void testSink0a() {
        ...
        binHeap[1] = c;
        binHeap[2] = a;
        Iterable<String> pq = new PriorityQueue_4ary<>(true, binHeap, 0, 3, Comparator.comparing(String::toString), false);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
    ...
    public void testSink0b() {
        ...
        binHeap[2] = b;
        binHeap[3] = c;
        Iterable<String> pq = new PriorityQueue_4ary<>(true, binHeap, 1, 3, Comparator.comparing(String::toString), false);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
    ...
    public void testGive1() {
        PriorityQueue_4ary<String> pq = new PriorityQueue_4ary<>(10, Comparator.comparing(String::toString));
        String key = "A";
        pq.give(key);
    ...
    public void testGive2() {
        ...
        PriorityQueue_4ary<String> pq = new PriorityQueue_4ary<>(1, Comparator.comparing(String::toString));
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
        String key = "A";
    ...
    @Test
    public void isEmpty() {
        PriorityQueue_4ary<String> pq = new PriorityQueue_4ary<>(10, false, Comparator.comparing(String::toString));
        assertTrue(pq.isEmpty());
    }
    ...
    public void doTake01() throws PQException {
        ...
        binHeap[1] = "B";
        binHeap[2] = "C";
        PriorityQueue_4ary<String> pq = new PriorityQueue_4ary<>(false, binHeap, 0, 3, Comparator.comparing(String::toString), false);
        pq.doTake(pq::snake);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
        assertEquals("B", tester.invokePrivate("peek", 0));
    }
    ...
    public void doTake02() throws PQException {
        ...
        binHeap[1] = "A";
        binHeap[2] = "B";
        PriorityQueue_4ary<String> pq = new PriorityQueue_4ary<>(true, binHeap, 0, 3, Comparator.comparing(String::toString), false);
        pq.doTake(pq::sink);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
        assertEquals("B", tester.invokePrivate("peek", 0));
    }
    ...
    public void doTake11() throws PQException {
        ...
        binHeap[2] = "B";
        binHeap[3] = "C";
        PriorityQueue_4ary<String> pq = new PriorityQueue_4ary<>(false, binHeap, 1, 3, Comparator.comparing(String::toString), false);
        pq.doTake(pq::snake);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
        assertEquals("B", tester.invokePrivate("peek", 1));
    }
    ...
    public void doTake12() throws PQException {
        ...
        binHeap[2] = "A";
        binHeap[3] = "B";
        PriorityQueue_4ary<String> pq = new PriorityQueue_4ary<>(true, binHeap, 1, 3, Comparator.comparing(String::toString), false);
        pq.doTake(pq::sink);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
        assertEquals("B", tester.invokePrivate("peek", 1));
    }
    ...
    public void testGetMax() {
        Iterable<String> pq = new PriorityQueue_4ary<>(10, false, Comparator.comparing(String::toString));
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
    ...
    public void testTake4() throws PQException {
        ...
        binHeap[3] = "C";
        binHeap[4] = "B";
        PriorityQueue_4ary<String> pq = new PriorityQueue_4ary<>(true, binHeap, 1, 4, Comparator.comparing(String::toString), false);
    ...
    public void testTake5() throws PQException {
        ...
        binHeap[3] = "B";
        binHeap[4] = "Z";
        PriorityQueue_4ary<String> pq = new PriorityQueue_4ary<>(false, binHeap, 1, 4, Comparator.comparing(String::toString), false);
        String takenValue = pq.take();
    ...
    public void testTake6() throws PQException {
        PriorityQueue_4ary<String> pq = new PriorityQueue_4ary<>(5, Comparator.comparing(String::toString));
        pq.take(); // Attempting to take from an empty queue should throw PQException.
    }

    @Test
    public void testPriorityQueue_4aryList() throws PQException {
        ...
        PriorityQueue_4ary<Integer> pq = new PriorityQueue_4ary<>(list, Integer::compare);
    ...
    public void testDoHeapifya() throws PQException {
        ...
        boolean max = false;
        PriorityQueue_4ary<String> pq = new PriorityQueue_4ary<>(max, binHeap, 1, 5, Comparator.comparing(String::toString), false);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
        //original:         assertEquals(5, tester.invokePrivate("doHeapifyStandard", 2));
        //changed for 4-ary structure
        assertEquals(2, tester.invokePrivate("doHeapifyStandard", 2));
    ...
    public void testDoHeapifyb() throws PQException {
        ...
        boolean max = false;
        PriorityQueue_4ary<String> pq = new PriorityQueue_4ary<>(max, binHeap, 0, 5, Comparator.comparing(String::toString), false);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
        //original:         assertEquals(4, tester.invokePrivate("doHeapifyStandard", 1));
        //changed for 4-ary structure
        assertEquals(1, tester.invokePrivate("doHeapifyStandard", 1));
